...
CREATE TABLE `crm_lead` (
  ...
  `sales_rep` int(3) NOT NULL,
  `project_description` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;


INSERT INTO `crm_lead` (`id`, `contact_first`, `contact_last`, `initial_contact_date`, `company`, `industry`, `address`, `city`, `state`, `country`, `zip`, `phone`, `email`, `status`, `website`, `sales_rep`, `project_type`, `project_description`) VALUES
(1, 'David', 'Smith', '0000-00-00 00:00:00', 'ABC', 'Food', '', '', '', 'France', 112245, 123456789, 'david@tes.com', 'Lead', 'www.testabc.com', 1, '', ''),
(2, 'Goerge', 'Wood', '0000-00-00 00:00:00', 'XYZ', 'Motor', '', '', '', '', 0, 123456789, 'goerg@test.com', 'Lead', 'www.mtobc.com', 1, '', ''),
(5, 'adam', 'smith', '2020-11-13 20:47:02', 'vzxvzx', 'xzvzx', '', '', '', '', 0, 123456789, 'dgsdgsd@wty.com', 'Lead', 'www.mtobc.com', 1, '', ''),
(6, 'xvzxxzv', 'xvzxvzxv', '2020-11-13 20:56:27', 'uyttyi', 'reyery', '', '', '', '', 0, 123456789, 'werwrwe@wr.com', 'Lead', 'www.fggg.com', 1, '', '');
